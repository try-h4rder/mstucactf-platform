...
1. Task-Based (или Jeopardy) — решение заданий как в одиночку так и в команде,
2. и Classic (или Attack-Defense) — режим, в котором команде предстоит найти и устранить уязвимости в своих сервисах, и проэксплуатировать найденные уязвимости на сервисах других команд.
